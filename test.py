...
def process_unread_messages(service):
    messages = list_messages_matching_query(service, "me", "label:unread")
    for message in messages:
        ...
        if subject == "foto":
            ...
            response = create_message("Emma Eternal Magic", fromAddressParsed, 'Wiadomosc od Emmy', 'Wiadomosc')
            response2 = create_message_with_attachment("Emma Eternal Magic", fromAddressParsed, "Ja", "",
                                                       "/home/kamil/tmp",
                                                       "emma.jpg")

            send_message(service, "me", response2)

            modify_message(service, 'me', message['id'], create_read_labels())
